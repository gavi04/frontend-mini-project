...
//         `http://localhost:3000/users/${userInfo.userId}/applications`,
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
...
//                 <p className="text-gray-600">Applied on: {application.createdAt ? formatDate(application.createdAt) : 'Date not available'}</p>
